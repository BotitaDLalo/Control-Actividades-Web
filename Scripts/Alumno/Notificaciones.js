function initNotificacionesAlumno() {
...
if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', initNotificacionesAlumno); else initNotificacionesAlumno();
